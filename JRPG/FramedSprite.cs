...
namespace JRPG
{
    public class FramedSprite : Sprite
    {
        ...
        public FramedSprite(int pFramesX, int pFramesY, int pBorderSize, Texture2D pTexture, Vector2 pPosition, Color pTint, float scale) : base(pTexture, pPosition, pTint, scale)
        {
            framesX = pFramesX;
            framesY = pFramesY;
